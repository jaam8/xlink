...
Вот так планировали:
![planned_arch.png](planned_arch.png)
Вот к такой пришли:
![final_arch.png](final_arch.png)
...
5. **tg_bot** - телеграм-клиент для сервиса, имеющий доступ к другим сервисам без
необходимости делать запросы в **gateway**
